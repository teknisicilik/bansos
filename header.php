...
loadjs.ready("head", function() {
	...
	$(".ew-login-form").prepend('<div class="area" ><ul class="circles"><li></li><li></li><li></li><li><z/li><li></li><li></li><li></li><li></li><li></li><li></li></ul></div>'),$(".login-box-msg").prepend("<img style='display:block;margin:auto;padding-top:15px;padding-bottom:15px;max-width:300px;height: auto;' src='images/logo.png'>");
});
</script>
<!-- Navbar -->
	...
	<nav class="<?php echo Config("NAVBAR_CLASS") ?>">
		...
		<ul id="ew-navbar" class="navbar-nav">
			...
			<a class="navbar-brand d-none" href="#"  onclick="return false;">
				<img src="<?php echo $RELATIVE_PATH ?>images/logo.png" alt="" class="brand-image ew-brand-image">
			</a>
		</ul>
		<!-- Right navbar links -->
