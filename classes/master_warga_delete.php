 ...
 * Page class
 */
class master_warga_delete extends master_warga
{
	...
	// Page object name
	public $PageObjName = "master_warga_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("master_wargalist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecords <= 0) { // No record found, exit
				...
				$this->terminate("master_wargalist.php"); // Return to list
			}
		}
	}
