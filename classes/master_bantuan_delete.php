 ...
 * Page class
 */
class master_bantuan_delete extends master_bantuan
{
	...
	// Page object name
	public $PageObjName = "master_bantuan_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("master_bantuanlist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecords <= 0) { // No record found, exit
				...
				$this->terminate("master_bantuanlist.php"); // Return to list
			}
		}
	}
