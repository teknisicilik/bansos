...
class kabupaten extends DbTable
{
	...
	public function __construct()
	{
		...
		// id
		$this->id = new DbField('kabupaten', 'kabupaten', 'x_id', 'id', '`id`', '`id`', 2, 6, -1, FALSE, '`id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// provinsi_id
		$this->provinsi_id = new DbField('kabupaten', 'kabupaten', 'x_provinsi_id', 'provinsi_id', '`provinsi_id`', '`provinsi_id`', 16, 4, -1, FALSE, '`provinsi_id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		switch ($CurrentLanguage) {
			case "en":
				$this->provinsi_id->Lookup = new Lookup('provinsi_id', 'provinsi', FALSE, 'id', ["nama","","",""], [], [], [], [], [], [], '', '');
				break;
			case "id":
				$this->provinsi_id->Lookup = new Lookup('provinsi_id', 'provinsi', FALSE, 'id', ["nama","","",""], [], [], [], [], [], [], '', '');
				break;
		...
		// nama
		$this->nama = new DbField('kabupaten', 'kabupaten', 'x_nama', 'nama', '`nama`', '`nama`', 200, 30, -1, FALSE, '`nama`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
	...
	{
		if ($parm != "")
			$url = $this->keyUrl("kabupatenview.php", $this->getUrlParm($parm));
		else
			$url = $this->keyUrl("kabupatenview.php", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
	...
	{
		if ($parm != "")
			$url = "kabupatenadd.php?" . $this->getUrlParm($parm);
		else
	...
	{
		$url = $this->keyUrl("kabupatenedit.php", $this->getUrlParm($parm));
		return $this->addMasterUrl($url);
	}
	...
	{
		$url = $this->keyUrl("kabupatenadd.php", $this->getUrlParm($parm));
		return $this->addMasterUrl($url);
	}
	...
	{
		return $this->keyUrl("kabupatendelete.php", $this->getUrlParm());
	}
