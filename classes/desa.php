...
/**
 * Table class for desa
 */
class desa extends DbTable
{
	protected $SqlFrom = "";
	protected $SqlSelect = "";
	...
	public function __construct()
	{
		...
		// id
		$this->id = new DbField('desa', 'desa', 'x_id', 'id', '`id`', '`id`', 20, 20, -1, FALSE, '`id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// kecamatan_id
		$this->kecamatan_id = new DbField('desa', 'desa', 'x_kecamatan_id', 'kecamatan_id', '`kecamatan_id`', '`kecamatan_id`', 3, 11, -1, FALSE, '`kecamatan_id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		switch ($CurrentLanguage) {
			case "en":
				$this->kecamatan_id->Lookup = new Lookup('kecamatan_id', 'kecamatan', FALSE, 'id', ["nama","","",""], [], [], [], [], [], [], '', '');
				break;
			case "id":
				$this->kecamatan_id->Lookup = new Lookup('kecamatan_id', 'kecamatan', FALSE, 'id', ["nama","","",""], [], [], [], [], [], [], '', '');
				break;
		...
		// nama
		$this->nama = new DbField('desa', 'desa', 'x_nama', 'nama', '`nama`', '`nama`', 200, 40, -1, FALSE, '`nama`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// kodepos
		$this->kodepos = new DbField('desa', 'desa', 'x_kodepos', 'kodepos', '`kodepos`', '`kodepos`', 3, 11, -1, FALSE, '`kodepos`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
	...
	public function getDetailUrl()
	{
		...
		// Detail url
		$detailUrl = "";
		if ($this->getCurrentDetailTable() == "rw") {
			$detailUrl = $GLOBALS["rw"]->getListUrl() . "?" . Config("TABLE_SHOW_MASTER") . "=" . $this->TableVar;
			$detailUrl .= "&fk_id=" . urlencode($this->id->CurrentValue);
		}
		if ($detailUrl == "")
			$detailUrl = "desalist.php";
		return $detailUrl;
	}
	...
	{
		return ($this->SqlFrom != "") ? $this->SqlFrom : "`desa`";
	}
	...
	public function getSqlWhere() // Where
	{
		...
		$this->TableFilter = "`kecamatan_id` ".filterKelurahan()."";
	...
	public function getModalCaption($pageName)
	{
		...
		elseif ($pageName == "desaedit.php")
			return $Language->phrase("Edit");
		elseif ($pageName == "desaadd.php")
	...
	{
		if ($parm != "")
			$url = $this->keyUrl("desaview.php", $this->getUrlParm($parm));
		else
			$url = $this->keyUrl("desaview.php", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
	...
	{
		if ($parm != "")
			$url = "desaadd.php?" . $this->getUrlParm($parm);
		else
			$url = "desaadd.php";
		return $this->addMasterUrl($url);
	}
	...
	{
		if ($parm != "")
			$url = $this->keyUrl("desaedit.php", $this->getUrlParm($parm));
		else
			$url = $this->keyUrl("desaedit.php", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
		return $this->addMasterUrl($url);
	}
	...
	{
		if ($parm != "")
			$url = $this->keyUrl("desaadd.php", $this->getUrlParm($parm));
		else
			$url = $this->keyUrl("desaadd.php", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
		return $this->addMasterUrl($url);
	}
	...
	{
		return $this->keyUrl("desadelete.php", $this->getUrlParm());
	}
