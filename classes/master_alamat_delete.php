 ...
 * Page class
 */
class master_alamat_delete extends master_alamat
{
	...
	// Page object name
	public $PageObjName = "master_alamat_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("master_alamatlist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecords <= 0) { // No record found, exit
				...
				$this->terminate("master_alamatlist.php"); // Return to list
			}
		}
	}
