...
class rt_grid extends rt
{
	...
	// Page object name
	public $PageObjName = "rt_grid";

	// Grid form hidden field names
	public $FormName = "frtgrid";
...
// Render list options (extended codes)
	...
	protected function addRow($rsold = NULL)
	{
		...
		// Set up foreign key field value from Session
			if ($this->getCurrentMasterTable() == "rw") {
				$this->rw_id->CurrentValue = $this->rw_id->getSessionValue();
			}
	...
	protected function setupMasterParms()
	{
		...
		if ($masterTblVar == "rw") {
			$this->rw_id->Visible = FALSE;
			if ($GLOBALS["rw"]->EventCancelled)
