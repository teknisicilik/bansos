...
class cari_bantuan
{
	...
	// Table name
	public $TableName = 'cari_bantuan.php';

	// Page object name
	public $PageObjName = "cari_bantuan";
	...
	public function __construct()
	{
		...
		if (!defined(PROJECT_NAMESPACE . "TABLE_NAME"))
			define(PROJECT_NAMESPACE . "TABLE_NAME", 'cari_bantuan.php');
	...
	protected function setupBreadcrumb()
	{
		...
		$Breadcrumb->add("custom", "cari_bantuan", $url, "", "cari_bantuan", TRUE);
		$this->Heading = $Language->TablePhrase("cari_bantuan", "TblCaption"); 
	}
} // End class
?>