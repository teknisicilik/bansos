 ...
 * Page class
 */
class master_warga_edit extends master_warga
{
	...
	// Page object name
	public $PageObjName = "master_warga_edit";
	...
	protected function editRow()
	{
		...
		if ($rs->EOF) {
			...
			// kk
			$this->kk->setDbValueDef($rsnew, $this->kk->CurrentValue, "", $this->kk->ReadOnly);

			// nik
			$this->nik->setDbValueDef($rsnew, $this->nik->CurrentValue, 0, $this->nik->ReadOnly);
			...
			// alamat_id
			$this->alamat_id->setDbValueDef($rsnew, $this->alamat_id->CurrentValue, 0, $this->alamat_id->ReadOnly);

			// nomor_rumah
			$this->nomor_rumah->setDbValueDef($rsnew, $this->nomor_rumah->CurrentValue, "", $this->nomor_rumah->ReadOnly);

			// keterangan
			$this->keterangan->setDbValueDef($rsnew, $this->keterangan->CurrentValue, NULL, $this->keterangan->ReadOnly);

			// status_warga_id
			$this->status_warga_id->setDbValueDef($rsnew, $this->status_warga_id->CurrentValue, NULL, $this->status_warga_id->ReadOnly);
