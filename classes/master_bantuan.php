...
/**
 * Table class for master_bantuan
 */
class master_bantuan extends DbTable
{
	protected $SqlFrom = "";
	protected $SqlSelect = "";
	...
	public function __construct()
	{
		...
		$this->TableVar = 'master_bantuan';
		$this->TableName = 'master_bantuan';
		$this->TableType = 'TABLE';

		// Update Table
		$this->UpdateTable = "`master_bantuan`";
		$this->Dbid = 'DB';
		$this->ExportAll = TRUE;
		...
		// id
		$this->id = new DbField('master_bantuan', 'master_bantuan', 'x_id', 'id', '`id`', '`id`', 3, 11, -1, FALSE, '`id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'NO');
		...
		// jenis_bantuan_id
		$this->jenis_bantuan_id = new DbField('master_bantuan', 'master_bantuan', 'x_jenis_bantuan_id', 'jenis_bantuan_id', '`jenis_bantuan_id`', '`jenis_bantuan_id`', 3, 11, -1, FALSE, '`jenis_bantuan_id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// nama
		$this->nama = new DbField('master_bantuan', 'master_bantuan', 'x_nama', 'nama', '`nama`', '`nama`', 200, 100, -1, FALSE, '`nama`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// type
		$this->type = new DbField('master_bantuan', 'master_bantuan', 'x_type', 'type', '`type`', '`type`', 202, 1, -1, FALSE, '`type`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'RADIO');
		$this->type->Nullable = FALSE; // NOT NULL field
		$this->type->Sortable = TRUE; // Allow sort
		switch ($CurrentLanguage) {
			case "en":
				$this->type->Lookup = new Lookup('type', 'master_bantuan', FALSE, '', ["","","",""], [], [], [], [], [], [], '', '');
				break;
			case "id":
				$this->type->Lookup = new Lookup('type', 'master_bantuan', FALSE, '', ["","","",""], [], [], [], [], [], [], '', '');
				break;
		...
		// jumlah
		$this->jumlah = new DbField('master_bantuan', 'master_bantuan', 'x_jumlah', 'jumlah', '`jumlah`', '`jumlah`', 200, 100, -1, FALSE, '`jumlah`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// sumber_bantuan_id
		$this->sumber_bantuan_id = new DbField('master_bantuan', 'master_bantuan', 'x_sumber_bantuan_id', 'sumber_bantuan_id', '`sumber_bantuan_id`', '`sumber_bantuan_id`', 3, 11, -1, FALSE, '`sumber_bantuan_id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		$this->pengambilan_bantuuan_id = new DbField('master_bantuan', 'master_bantuan', 'x_pengambilan_bantuuan_id', 'pengambilan_bantuuan_id', '`pengambilan_bantuuan_id`', '`pengambilan_bantuuan_id`', 3, 11, -1, FALSE, '`pengambilan_bantuuan_id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// frekuensi
		$this->frekuensi = new DbField('master_bantuan', 'master_bantuan', 'x_frekuensi', 'frekuensi', '`frekuensi`', '`frekuensi`', 200, 100, -1, FALSE, '`frekuensi`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// bulan
		$this->bulan = new DbField('master_bantuan', 'master_bantuan', 'x_bulan', 'bulan', '`bulan`', '`bulan`', 200, 10, -1, FALSE, '`bulan`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		switch ($CurrentLanguage) {
			case "en":
				$this->bulan->Lookup = new Lookup('bulan', 'master_bantuan', FALSE, '', ["","","",""], [], [], [], [], [], [], '', '');
				break;
			case "id":
				$this->bulan->Lookup = new Lookup('bulan', 'master_bantuan', FALSE, '', ["","","",""], [], [], [], [], [], [], '', '');
				break;
		...
		// tahun
		$this->tahun = new DbField('master_bantuan', 'master_bantuan', 'x_tahun', 'tahun', '`tahun`', '`tahun`', 3, 11, -1, FALSE, '`tahun`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// keterangan
		$this->keterangan = new DbField('master_bantuan', 'master_bantuan', 'x_keterangan', 'keterangan', '`keterangan`', '`keterangan`', 201, 65535, -1, FALSE, '`keterangan`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXTAREA');
		$this->keterangan->Sortable = TRUE; // Allow sort
		$this->fields['keterangan'] = &$this->keterangan;

		// status
		$this->status = new DbField('master_bantuan', 'master_bantuan', 'x_status', 'status', '`status`', '`status`', 3, 11, -1, FALSE, '`status`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		switch ($CurrentLanguage) {
			case "en":
				$this->status->Lookup = new Lookup('status', 'master_bantuan', FALSE, '', ["","","",""], [], [], [], [], [], [], '', '');
				break;
			case "id":
				$this->status->Lookup = new Lookup('status', 'master_bantuan', FALSE, '', ["","","",""], [], [], [], [], [], [], '', '');
				break;
		...
		// na
		$this->na = new DbField('master_bantuan', 'master_bantuan', 'x_na', 'na', '`na`', '`na`', 202, 1, -1, FALSE, '`na`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'RADIO');
		...
		switch ($CurrentLanguage) {
			case "en":
				$this->na->Lookup = new Lookup('na', 'master_bantuan', FALSE, '', ["","","",""], [], [], [], [], [], [], '', '');
				break;
			case "id":
				$this->na->Lookup = new Lookup('na', 'master_bantuan', FALSE, '', ["","","",""], [], [], [], [], [], [], '', '');
				break;
	...
	public function getDetailUrl()
	{
		...
		// Detail url
		$detailUrl = "";
		if ($this->getCurrentDetailTable() == "bantuan") {
			$detailUrl = $GLOBALS["bantuan"]->getListUrl() . "?" . Config("TABLE_SHOW_MASTER") . "=" . $this->TableVar;
			$detailUrl .= "&fk_id=" . urlencode($this->id->CurrentValue);
		}
		if ($detailUrl == "")
			$detailUrl = "master_bantuanlist.php";
		return $detailUrl;
	}
	...
	{
		return ($this->SqlFrom != "") ? $this->SqlFrom : "`master_bantuan`";
	}
	...
	{
		global $Language;
		if ($pageName == "master_bantuanview.php")
			return $Language->phrase("View");
		elseif ($pageName == "master_bantuanedit.php")
			return $Language->phrase("Edit");
		elseif ($pageName == "master_bantuanadd.php")
	...
	{
		if ($parm != "")
			$url = $this->keyUrl("master_bantuanview.php", $this->getUrlParm($parm));
		else
			$url = $this->keyUrl("master_bantuanview.php", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
	...
	{
		if ($parm != "")
			$url = "master_bantuanadd.php?" . $this->getUrlParm($parm);
		else
			$url = "master_bantuanadd.php";
		return $this->addMasterUrl($url);
	}
	...
	{
		if ($parm != "")
			$url = $this->keyUrl("master_bantuanedit.php", $this->getUrlParm($parm));
		else
			$url = $this->keyUrl("master_bantuanedit.php", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
		return $this->addMasterUrl($url);
	}
	...
	{
		if ($parm != "")
			$url = $this->keyUrl("master_bantuanadd.php", $this->getUrlParm($parm));
		else
			$url = $this->keyUrl("master_bantuanadd.php", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
		return $this->addMasterUrl($url);
	}
	...
	{
		return $this->keyUrl("master_bantuandelete.php", $this->getUrlParm());
	}
