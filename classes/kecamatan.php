...
class kecamatan extends DbTable
{
	...
	public function __construct()
	{
		...
		// id
		$this->id = new DbField('kecamatan', 'kecamatan', 'x_id', 'id', '`id`', '`id`', 3, 7, -1, FALSE, '`id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// idkabupaten
		$this->idkabupaten = new DbField('kecamatan', 'kecamatan', 'x_idkabupaten', 'idkabupaten', '`idkabupaten`', '`idkabupaten`', 2, 6, -1, FALSE, '`idkabupaten`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// nama
		$this->nama = new DbField('kecamatan', 'kecamatan', 'x_nama', 'nama', '`nama`', '`nama`', 200, 30, -1, FALSE, '`nama`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
	...
	public function getSqlWhere() // Where
	{
		...
		$this->TableFilter = "`idkabupaten` = ".kabupatenId()."";
	...
	public function getModalCaption($pageName)
	{
		...
		elseif ($pageName == "kecamatanedit.php")
			return $Language->phrase("Edit");
		elseif ($pageName == "kecamatanadd.php")
	...
	{
		if ($parm != "")
			$url = $this->keyUrl("kecamatanview.php", $this->getUrlParm($parm));
		else
			$url = $this->keyUrl("kecamatanview.php", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
	...
	{
		if ($parm != "")
			$url = "kecamatanadd.php?" . $this->getUrlParm($parm);
		else
	...
	{
		$url = $this->keyUrl("kecamatanedit.php", $this->getUrlParm($parm));
		return $this->addMasterUrl($url);
	}
	...
	{
		$url = $this->keyUrl("kecamatanadd.php", $this->getUrlParm($parm));
		return $this->addMasterUrl($url);
	}
	...
	{
		return $this->keyUrl("kecamatandelete.php", $this->getUrlParm());
	}
	...
	public function loadListRowValues(&$rs)
	{
		...
		$this->idkabupaten->setDbValue($rs->fields('idkabupaten'));
