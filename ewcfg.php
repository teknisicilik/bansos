...
// Project
define(PROJECT_NAMESPACE . "PROJECT_NAME", "bansos"); // Project name
...
$CONFIG = [
	...
	"RANDOM_KEY" => '33EcHObQPpnp1qrk', // Random key for encryption
	"ENCRYPTION_KEY" => '', // Encryption key for data protection
	"PROJECT_STYLESHEET_FILENAME" => "css/bansos.css", // Project stylesheet file name
	...
	"PROJECT_ID" => "{43B9593C-AF46-4926-9D51-8DAD45DAA7A2}", // Project ID (GUID)
	...
	"SIDEBAR_CLASS" => "main-sidebar sidebar-light-danger",
	...
	"CONNECTION_INFO" => [
		"DB" => ["id" => "DB", "type" => "MYSQL", "qs" => "`", "qe" => "`", "host" => "localhost", "port" => "3306", "user" => "root", "pass" => "", "db" => "bansos"]
	],
...
$LANGUAGES = [["en","","english.xml"],["id","","indonesia.xml"]];
